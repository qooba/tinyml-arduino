...
Vue.component("line-chart-magnetometer", {
...
Vue.component('magnetometer', {
  ...
  methods: {
    ...
    prepare(){
        axios.get("/api/arduino/magnetometer").then(response => {
  ...
  <div class="mdl-grid demo-content">
    <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--6-col mdl-grid center-align ">
        <div class="typo-styles__demo mdl-typography--title">Magnetometer:</div>
    ...
    <div class="demo-graphs mdl-shadow--2dp mdl-color--white mdl-cell mdl-cell--12-col">
        <line-chart-magnetometer :data="dataChart" :dataY="dataChartY" :dataZ="dataChartZ" :labels="labels" :options="{responsive: true, maintainAspectRatio: false}"></line-chart-magnetometer>
    </div>
  </div>
</main>
  `
