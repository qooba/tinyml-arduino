...
Vue.component("line-chart-gyroscope", {
...
Vue.component('gyroscope', {
  ...
  methods: {
    ...
    prepare(){
        axios.get("/api/arduino/gyroscope").then(response => {
  ...
  <div class="mdl-grid demo-content">
    <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--6-col mdl-grid center-align ">
        <div class="typo-styles__demo mdl-typography--title">Gyroscope:</div>
    ...
    <div class="demo-graphs mdl-shadow--2dp mdl-color--white mdl-cell mdl-cell--12-col">
        <line-chart-gyroscope :data="dataChart" :dataY="dataChartY" :dataZ="dataChartZ" :labels="labels" :options="{responsive: true, maintainAspectRatio: false}"></line-chart-gyroscope>
    </div>
  </div>
</main>
  `
